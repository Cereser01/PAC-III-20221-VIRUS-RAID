...
func _ready():
	...
	$Label.rect_position = Vector2(Global.screensize_horiz/5, Global.screensize_vert/1.6)
...
func _on_Anterior_pressed():
	assert(get_tree().change_scene("res://Scenes/LinB(EN).tscn") == OK)
	pass # Replace with function body.


func _on_Proximo_pressed():
	assert(get_tree().change_scene("res://Scenes/AntibodyEN.tscn") == OK)
	pass # Replace with function body.
