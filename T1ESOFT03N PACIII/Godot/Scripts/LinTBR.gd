...
func _ready():
	...
	$Label.rect_position = Vector2(Global.screensize_horiz/4.5, Global.screensize_vert/1.6)
...
func _on_Anterior_pressed():
	assert(get_tree().change_scene("res://Scenes/LinB(BR).tscn") == OK)
	pass # Replace with function body.


func _on_Proximo_pressed():
	assert(get_tree().change_scene("res://Scenes/AntibodyBR.tscn") == OK)
	pass # Replace with function body.
