...
var bullet = preload("res://Scenes/Infected_Citotoxica_Bullet.tscn")
var can_shoot = true
var immunityframe = false
var virus
var infection_duration = 20
var flipflop = false

func _ready():
	Global.player = self
	Global.playertype = "citotoxica"
	Global.health = 1
...
func _process(delta):
	...
	if Global.health <=0 or infection_duration == 0:
		Global.infection += 5 * (1 - infection_duration/20)
