...
func _ready():
	...
	$AntiBody.position +=  Vector2(Global.screensize_horiz/5 -120, Global.screensize_vert/8)
	$Label.rect_position = Vector2(Global.screensize_horiz/7, Global.screensize_vert/2)
...
func _on_Anterior_pressed():
	assert(get_tree().change_scene("res://Scenes/LinTBR.tscn") == OK)
	pass # Replace with function body.


func _on_Proximo_pressed():
	assert(get_tree().change_scene("res://Scenes/citotoxic(BR).tscn") == OK)
	pass # Replace with function body.
